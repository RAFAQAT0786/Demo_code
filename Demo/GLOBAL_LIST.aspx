<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="GLOBAL_LIST.aspx.cs" Inherits="GLOBAL_LIST" Title="Global Category List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title">Global Category List</h3>
        <ul class="breadcrumb">
            <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
            <li>Global Category List</li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="GLOBAL_CREATE.aspx" class="btn purple" style="text-align: right;">Create New Global Category</a>
                <asp:LinkButton class="btn red" Text="Delete Global Category" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton1" runat="server" />
            </div>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Global Category List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="GLOBAL_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("GLOBAL_ID")%>' onclick="SelectUnSelect(this)"
                                            id="chkSelect" />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:TemplateField>
                                <asp:BoundField DataField="GLOBAL_NAME" HeaderText="Name" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Modify">
                                    <ItemTemplate>
                                        <a href='GLOBAL_CREATE.aspx?id=<%#Eval("GLOBAL_ID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetGLOBAL" TypeName="BLLAge"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_GLOBAL_MASTER">
        <DeleteParameters>
            <asp:Parameter Name="GLOBAL_ID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
...
function F()
{
    var res = confirm('Do You Want to Delete Global Category Detail?');
//alert(res);
if(res==false)
{return false;
}
