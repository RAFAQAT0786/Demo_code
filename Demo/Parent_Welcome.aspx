<%@ Page Language="C#" MasterPageFile="~/Parent.master" AutoEventWireup="true" CodeFile="Parent_Welcome.aspx.cs" Inherits="Parent_Welcome" Title="Parent DashBoard" %>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <ul class="breadcrumb">
                <li>
                    <i class="icon-home"></i>
                    <a href="Parent_Welcome.aspx">Home</a>
                    <i class="icon-angle-right"></i>
                </li>
                <li><a href="Parent_Welcome.aspx">Dashboard</a></li>
