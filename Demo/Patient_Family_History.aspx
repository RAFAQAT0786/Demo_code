<%@ Page Language="C#" MasterPageFile="~/Admin.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="Patient_Family_History.aspx.cs" Inherits="Patient_Family_History" Title="Patient Family History Information" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title"><span class="username">
            <asp:Label ID="PTP_TXT" runat="server" /></span> Family History Information</h3>
        <ul class="breadcrumb">
            <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
            <li><i class="icon-table"></i><a href="Patient.aspx">Patient List</a> <i class="icon-angle-right"></i></li>
            <li>Patient Family History Information</li>
        </ul>
    </div>
            ...
            <div class="span12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-reorder"></i>Patient Family History Information
                        </div>
                    </div>
                        ...
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="colhide" HeaderText="ID2" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="PTFH_ID" Visible="false" runat="server" Text='<%#Eval("PTFH_ID")%>'></asp:Label>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetPatientFHisNEW" TypeName="BLLAge"
