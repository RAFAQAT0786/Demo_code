...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row-fluid" runat="server" id="pt1">
        <div class="span12">
    ...
    <div class="portlet-body form" runat="server" id="remark">
        <div class="form-horizontal">
            <div class="row-fluid">
                <div class="span6" style="margin-bottom: -15px;">
                    <div class="control-group">
    ...
    <div class="row-fluid" runat="server" id="dis">
        <div class="span12">
...
else
{
    ...
    if (vData=="")
    {
        ...
        function ShowModalPopup() {
            $get("video").src = "https://www.youtube.com/embed/GrfPXTAQrTc";
            $find("mpe").show();
            return false;
        }
