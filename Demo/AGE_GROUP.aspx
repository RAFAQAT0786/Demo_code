<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Age_Group.aspx.cs" Inherits="Age_Group" Title="Age Group List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title">Age Group List</h3>
        <ul class="breadcrumb">
            <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
            <li>Age Group List</li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="Age_Group_Create.aspx" class="btn purple" style="text-align: right;">Create New Age Group</a>
                <asp:LinkButton class="btn red" Text="Delete Age Group" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton1" runat="server" />
            </div>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Age Group List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="AGRP_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("AGRP_ID")%>' onclick="SelectUnSelect(this)"
                                            id="chkSelect" />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Resources Video Link" HeaderStyle-Width="400px" >
                                        <ItemTemplate>
                                            <asp:HyperLink ID="AGRP_VIDEO_LINK" runat="server" NavigateUrl='<%#Eval("AGRP_VIDEO_LINK")%>' Text='<%#Eval("AGRP_VIDEO_LINK")%>'></asp:HyperLink>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="left" />
                                    </asp:TemplateField>
                                <asp:TemplateField HeaderText="Modify">
                                    <ItemTemplate>
                                        <a href='Age_Group_Create.aspx?id=<%#Eval("AGRP_ID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetAge" TypeName="BLLAge"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_AGE_GRP_MASTER">
        <DeleteParameters>
...
function F()
{var res = confirm('Do You Want to Delete Age Detail?');
//alert(res);
if(res==false)
{return false;
}
