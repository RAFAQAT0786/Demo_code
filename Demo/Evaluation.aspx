<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Evaluation.aspx.cs" Inherits="Evaluation" Title="Evaluation List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid" style="height: 120px;">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="Evaluation_Create.aspx">Evaluation List</a></li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="Evaluation_Create.aspx" class="btn purple" style="text-align: right;">Create New Evaluation</a>
                <asp:LinkButton class="btn red" Text="Delete Evaluation" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton1" runat="server" />
            </div>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Evaluation List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="EVA_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("EVA_ID")%>' onclick="SelectUnSelect(this)"
                                            id="chkSelect" />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:TemplateField>
                                <asp:BoundField DataField="EVA_NAME" HeaderText="Condition" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Modify">
                                    <ItemTemplate>
                                        <a href='Evaluation_Create.aspx?id=<%#Eval("EVA_ID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetEva" TypeName="BLLAge"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_EVALUATION_MASTER">
        <DeleteParameters>
            <asp:Parameter Name="EVA_ID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
...
function F()
{
    var res = confirm('Do You Want to Delete Evaluation Detail?');
//alert(res);
if(res==false)
{return false;
}
