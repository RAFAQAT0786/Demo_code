...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row-fluid" style="height:120px;"> 
        ...
        <ul class="breadcrumb" >
            ...
            <li><i class="icon-table"></i> <a href="Patient.aspx">Go To Patient Detail</a> <i class="icon-angle-right"></i></li>
              ...
              <%--<div class="form-horizontal">
                    <div class="control-group">
                      <label class="control-label">Recommendations<span class="required">*</span></label>
                        <div class="controls">
                            <textarea class="span12 ckeditor m-wrap" id="Textarea17" cols="30" runat="server" name="editor2" rows="20" data-error-container="#editor16_error"></textarea>
                          </div>
                        </div>
                     </div>--%>
                    ...
                    <div class="span12" style="margin-bottom:-15px;">
                       <div class="control-group">
                          <label class="control-label">Instructions<span class="required">*</span></label>
                            <div class="controls">
                                <asp:TextBox ID="TextBox1" runat="server" Visible="true" CssClass="span12 m-wrap" />
                           </div>
                        </div>
                     </div>
                     </div>--%>
