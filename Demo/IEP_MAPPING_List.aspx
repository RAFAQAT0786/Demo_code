<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="IEP_MAPPING_List.aspx.cs" Inherits="IEP_MAPPING_List" Title="IEP Mapping List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title">IEP Mapping List</h3>
        <ul class="breadcrumb">
            <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
            <li>IEP Mapping List</li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="IEP_MAPPING.aspx" class="btn purple" style="text-align: right;">Create New IEP Mapping</a>
                <asp:LinkButton class="btn red" Text="Delete IEP Mapping" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton1" runat="server" />
            </div>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>IEP Mapping List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="IEPMD_IEPMID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:BoundField DataField="DCAT_NAME" HeaderText="Category" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Modify">
                                    <ItemTemplate>
                                        <a href='IEP_MAPPING.aspx?id=<%#Eval("IEPMD_IEPMID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetIEPMAPPING" TypeName="BLLAGE"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_IEP_MAPPING">
        <DeleteParameters>
            <asp:Parameter Name="IEPM_ID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
