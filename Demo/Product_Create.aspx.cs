        ...
        if (TXTID.Value != "0")
            try
            {
                if (DDLCAT.SelectedItem.Text == HiddenField3.Value && DDLSUBCAT.SelectedItem.Text == HiddenField4.Value)
                {
                    ...
                    //vHashtable.Add("PRODM_MRP", PROD_MRP_TXT.Text);
                    //vHashtable.Add("PRODM_RET_PRICE", PROD_RTP_TXT.Text);
                    //vHashtable.Add("PRODM_SYNP", PROD_SYN_TXT.Text);
                    //vHashtable.Add("PRODM_STK_PRICE", PROD_STK_TXT.Text);
