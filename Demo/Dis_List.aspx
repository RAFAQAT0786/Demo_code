<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Dis_List.aspx.cs" Inherits="Dis_List" Title="Disorder List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title">Disorder List</h3>
        <ul class="breadcrumb">
    ...
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="Dis_Create.aspx" class="btn purple" style="text-align: right;">Create New Disorder</a>
                <asp:LinkButton class="btn red" Text="Delete Disorder" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton1" runat="server" />
            </div>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Disorder List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="DIS_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("DIS_ID")%>' onclick="SelectUnSelect(this)"
                                            id="chkSelect" />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:TemplateField>
                                <asp:BoundField DataField="DIS_NAME" HeaderText="Name" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Resources Video Link" HeaderStyle-Width="400px" >
                                        <ItemTemplate>
                                            <asp:HyperLink ID="DIS_VIDEO_LINK" runat="server" NavigateUrl='<%#Eval("DIS_VIDEO_LINK")%>' Text='<%#Eval("DIS_VIDEO_LINK")%>'></asp:HyperLink>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="left" />
                                    </asp:TemplateField>
                                <asp:TemplateField HeaderText="Modify">
                                    <ItemTemplate>
                                        <a href='Dis_Create.aspx?id=<%#Eval("DIS_ID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetDis" TypeName="BLLAge"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_DIS_MASTER">
        <DeleteParameters>
            <asp:Parameter Name="AGRP_ID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
