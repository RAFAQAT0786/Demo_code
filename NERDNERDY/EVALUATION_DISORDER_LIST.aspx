<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="EVALUATION_DISORDER_LIST.aspx.cs" Inherits="EVALUATION_DISORDER_LIST" Title="Evaluation Disorder List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title">Evaluation Disorder List</h3>
        <ul class="breadcrumb">
            <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
            <li>Evaluation Disorder List</li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;" runat="server" id="Eval">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="EVALUATION_DISORDER.aspx" class="btn purple" style="text-align: right;">Create New Evaluation Disorder</a>
                <asp:LinkButton class="btn red" Text="Delete Evaluation Disorder" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton1" runat="server" />
                <a href="Patient.aspx" class="btn purple" style="text-align: right;">Patient List</a>
            </div>
        </div>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;" runat="server" id="Div1">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="Patient.aspx" class="btn purple" style="text-align: right;">Patient List</a>
            </div>
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="EVADIS_DISID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <asp:CheckBox runat="server" value='<%#Eval("EVADIS_DISID")%>' onclick="SelectUnSelect(this)" ID="chkSelect" />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Modify">
                                    <ItemTemplate>
                                        <a href='EVALUATION_DISORDER.aspx?id=<%#Eval("EVADIS_DISID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="ID">
                                    <ItemTemplate>
                                        <asp:Label ID="EVADIS_DISID" runat="server" Text='<%#Eval("EVADIS_DISID")%>'></asp:Label>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetEVADIS" TypeName="BLLAge"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_EVALUATION_DISORDER">
        <DeleteParameters>
            <asp:Parameter Name="EVADIS_DISID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
...
function F()
{
    var res = confirm('Do You Want to Delete Evaluation Disorder Detail?');
//alert(res);
if(res==false)
{return false;
}
