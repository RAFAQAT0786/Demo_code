...
public class BLLAGE
{
    ...
    public DataTable GetParent(ATSession pATSession)
    {
        ...
        {
            Hashtable vHashtable23 = new Hashtable();
            vHashtable23.Add("CUSTMOBILE", url22);
            DataTable vDT23 = DBManager.Get(vHashtable23, "GET_CUST_MOBILENO");
            DataRow vDR23 = RetDR(DBManager.Get(vHashtable23, "GET_CUST_MOBILENO"));
            return vDT23;
        }
