<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Assessment_Template_List.aspx.cs" Inherits="Assessment_Template_List" Title="Assessment Template Detail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title">Assessment Template List</h3>
        <ul class="breadcrumb">
            <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a><i class="icon-angle-right"></i></li>
            <li>Assessment Template List</li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="Assessment_Template.aspx" class="btn purple" style="text-align: right;">Create New Assessment Template</a>
            <asp:LinkButton class="btn red" Text="Delete Assessment Template" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton" runat="server" />
            </div>
        </div>
    </div>
    <div class="row-fluid">
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Assessment Template List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="ASE_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("ASE_ID")%>' onclick="SelectUnSelect(this)"
                                                id="chkSelect" /></ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:TemplateField>
                                <asp:BoundField DataField="ASE_NAME" HeaderText="Assessment Template Name" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="View">
                                    <ItemTemplate>
                                        <a href='Assessment_Template.aspx?id=<%#Eval("ASE_ID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetAssessment" TypeName="BLLAGE"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_ASSESS_MASTER">
        <DeleteParameters>
...
function F()
{var res = confirm('Do You Want to Delete Assessment Template Detail?');
//alert(res);
if(res==false)
{return false;
}
