<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DOCTOR.master" CodeFile="DOWN_SYNDROME_RATING.aspx.cs" Inherits="DOWN_SYNDROME_RATING" Title="Down Syndrome Rating Detail" %>
    ...
    <script type="text/javascript" src="assets/plugins/bootstrap-wysihtml5/wysihtml5-0.3.0.js"></script> 
     <script type="text/javascript" src="assets/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>
        ...
        <div class="row-fluid" style="height:120px;"> 
            <h3 class="page-title"><span class="username"><asp:Label ID="Label1" runat="server"/></span>Down Syndrome Rating</h3>
                <ul class="breadcrumb" >
                    <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
                    <li><i class="icon-table"></i> <a href="Patient.aspx">Patient List</a> <i class="icon-angle-right"></i></li>
                    <li>Down Syndrome Rating</li>
                </ul>
            </div>    
    <div class="row-fluid">
        <div class="span12">
        ...
        <div class="row-fluid" id="Submitcar1" runat="server"> 
            <div class="span12">
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption"><i class="icon-table"></i>Down Syndrome Rating</div>
                        <div class="tools">
            ...
            <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" Width="100%" Height="100%"
                ...
                <Columns>
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:CheckBox runat="server" value='<%#Eval("DOWN_ID")%>' onclick="SelectUnSelect(this)" id="CheckBox2" />
                            </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="ID" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="DOWN_ID" runat="server" Text='<%#Eval("DOWN_ID")%>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="left"/>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Category" HeaderStyle-Width="900px">
                        <ItemTemplate>
                            <asp:Label ID="DOWN_NAME" runat="server" Text='<%#Eval("DOWN_NAME")%>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="left"/>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Physical Trait" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="300px">
                        <ItemTemplate>
                            <asp:Label ID="DOWN_TRAIT" runat="server" Text='<%#Eval("DOWN_TRAIT")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    </asp:TemplateField>
                 </Columns>
        ...
        <asp:GridView ID="GridView2" AutoGenerateColumns="false" runat="server" Width="100%" Height="100%"
                ...
                <Columns>
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:CheckBox runat="server" id="chkSelect" AutoPostBack="True" Checked='<%# Eval("PTDS_STATUS").ToString()=="1" ? true : false %>' Enabled='<%#(String.IsNullOrEmpty(Eval("PTDS_STATUS").ToString()) ? false: true) %>' />
                            </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    </asp:TemplateField>
