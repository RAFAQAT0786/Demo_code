<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Age_disorder_List.aspx.cs" Inherits="Age_disorder_List" Title="Age Disorder List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title">Age Group Wise Disorder List</h3>
        <ul class="breadcrumb">
            <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
            <li>Age Group Wise Disorder List</li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="Age_disorder.aspx" class="btn purple" style="text-align: right;">Create New Age Group Wise Disorder</a>
                <asp:LinkButton class="btn red" Text="Delete Age Group Wise Disorder" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton1" runat="server" />
            </div>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Age Group Wise Disorder List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="AGDM_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("AGDM_ID")%>' onclick="SelectUnSelect(this)"
                                            id="chkSelect" />
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:TemplateField>
                                <asp:BoundField DataField="AGRP_GROUP" HeaderText="Group Name" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Modify">
                                    <ItemTemplate>
                                        <a href='Age_disorder.aspx?id=<%#Eval("AGDM_ID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetAgegrpdis" TypeName="BLLAge"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_AGDIS_MASTER">
        <DeleteParameters>
...
function F()
{
    var res = confirm('Do You Want to Delete Age Group Wise Disorder List?');
//alert(res);
if(res==false)
{return false;
}
