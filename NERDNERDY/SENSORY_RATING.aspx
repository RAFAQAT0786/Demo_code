<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DOCTOR.master" CodeFile="SENSORY_RATING.aspx.cs" Inherits="SENSORY_RATING" Title="Sensory Rating Detail" %>
    ...
    <script type="text/javascript" src="assets/plugins/bootstrap-wysihtml5/wysihtml5-0.3.0.js"></script> 
     <script type="text/javascript" src="assets/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>
        ...
        <div class="row-fluid" style="height:120px;"> 
            <h3 class="page-title"><span class="username"><asp:Label ID="Label1" runat="server"/></span>Sensory Processing Rating Scale</h3>
                <ul class="breadcrumb" >
                    <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
                    <li><i class="icon-table"></i> <a href="Patient.aspx">Patient List</a> <i class="icon-angle-right"></i></li>
                    <li>Sensory Processing Rating Scale</li>
                </ul>
            </div>    
    <div class="row-fluid">
        <div class="span12">
    ...
    <div class="span12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-table"></i>Sensory Processing Rating Scale</div>
                <div class="tools">
            ...
            <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" Width="100%" Height="100%"
                ...
                <Columns>
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:CheckBox runat="server" value='<%#Eval("SEN_ID")%>' onclick="SelectUnSelect(this)" id="CheckBox2" />
                          </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="ID" HeaderStyle-Width="900px" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="SEN_ID" runat="server" Text='<%#Eval("SEN_ID")%>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Category" HeaderStyle-Width="900px">
                        <ItemTemplate>
                            <asp:Label ID="SEN_NAME" runat="server" Text='<%#Eval("SEN_NAME")%>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="left"/>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Physical Trait" HeaderStyle-HorizontalAlign="Left">
                        <ItemTemplate>
                            <asp:Label ID="SEN_TRAIT" runat="server" Text='<%#Eval("SEN_TRAIT")%>'></asp:Label>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    </asp:TemplateField>
        ...
        <asp:GridView ID="GridView2" AutoGenerateColumns="false" runat="server" Width="100%" Height="100%"
                ...
                <Columns>
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:CheckBox runat="server" id="chkSelect" AutoPostBack="True" Checked='<%# Eval("PTSEN_STATUS").ToString()=="1" ? true : false %>' Enabled='<%#(String.IsNullOrEmpty(Eval("PTSEN_STATUS").ToString()) ? false: true) %>' />
                          </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="ID" HeaderStyle-Width="900px" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="SEN_ID" runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="left"/>
                    </asp:TemplateField>
