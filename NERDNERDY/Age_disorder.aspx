                    ...
                    <div class="table table-striped table-bordered table-hover">
                        <asp:Panel ID="Panel1" ScrollBars="Vertical" runat="server" Height="100%" Width="100%">
                            <asp:GridView ID="AGE_GRP" AutoGenerateColumns="false" runat="server" Width="100%"
                                ...
                                OnRowDeleting="AGE_GRP_RowDeleting" OnRowCommand="AGE_GRP_RowCommand" OnRowUpdating="AGE_GRP_RowUpdating"
                                OnRowCancelingEdit="AGE_GRP_RowCancelingEdit" OnRowEditing="AGE_GRP_RowEditing">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Observation ID" Visible="false">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Observation" HeaderStyle-Width="500px">
                                        <ItemTemplate>
                                            <asp:TextBox ID="DOBS_DESC" runat="server" TextMode="MultiLine" Text='<%#Eval("DOBS_DESC")%>' Height="100px" Width="600px"></asp:TextBox>
                                        </ItemTemplate>
                                        <ItemStyle HorizontalAlign="left" />
                                    </asp:TemplateField>
