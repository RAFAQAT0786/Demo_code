...
public partial class Registration : BasePage
{
    ...
    //working code for save and pay button start
        ...
        if (Page.IsValid)
        {
            try
            {
                if (TXTID.Value == "0")
                {
                    ...
                    vHashtable.Add("last_user", "Parent");
    ...
    //working code for save and pay button end
