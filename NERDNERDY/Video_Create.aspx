<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Video_Create.aspx.cs" Inherits="Video_Create" Title="Edit Video Information" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <cc1:ToolkitScriptManager ID="aa" runat="server"></cc1:ToolkitScriptManager>
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title">Create New Video Link</h3>
        <ul class="breadcrumb">
            <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
            <li><a href="Product.aspx">Video List</a> <i class="icon-angle-right"></i></li>
            <li>Create New Video Information</li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn green" CausesValidation="false" PostBackUrl="~/Video_List.aspx">Video List</asp:LinkButton>
            </div>
        </div>
    </div>
        ...
        <div class="span12">
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-reorder"></i>Create New Video</div>
                </div>
                        ...
                        <div class="row-fluid">
                            <div class="span6" style="margin-bottom: -15px;">
                                <div class="control-group">
                                    ...
                                    <asp:RequiredFieldValidator ControlToValidate="DDLCAT" ForeColor="Red" ErrorMessage="Choose The Category" SetFocusOnError="true" ID="RequiredFieldValidator3" runat="server" />
                                    </div>
                                </div>
                            </div>
                            <div class="span6" style="margin-bottom: -15px;">
                            ...
                            <div class="span6" style="margin-bottom: -15px;">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ForeColor="Red" ErrorMessage="Fill the video-link" ControlToValidate="VIDEO_LINK" Display="Dynamic" SetFocusOnError="true" runat="server" />
                                    </div>
                                </div>
                            </div>
                         </div>
    ...
    <asp:HiddenField Value="0" ID="DSCATID" runat="server" />
