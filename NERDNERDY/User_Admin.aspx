...
<div class="row-fluid">
    ...
    <div class="span6" style="margin-bottom:-15px;">
        <div class="control-group">
           ...
           <div class="controls">
               <asp:TextBox CssClass="span12 m-wrap" ID="TXT_PIN" runat="server" autocomplete="off"/>
...
<div class="row-fluid">
    <div class="span6" style="margin-bottom:-15px;">
        <div class="control-group">
           ...
           <div class="controls">
               <asp:TextBox SkinID="etext" ID="TXT_EMAIL" CssClass="span12 m-wrap" runat="server" autocomplete="off"/>
               <asp:RequiredFieldValidator ID="R16" ControlToValidate="TXT_EMAIL" Display="Dynamic" SetFocusOnError="true" runat="server" ErrorMessage="Fill Email-Id"/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <asp:TextBox ID="TXT_START" runat="server" Placeholder="yyyy/MM/dd" CssClass="span12 m-wrap" autocomplete="off"/>
                    ...
                    <asp:RequiredFieldValidator Display="Dynamic" ErrorMessage="Fill Start Date" ControlToValidate="TXT_START" runat="server"/>
            </div>
        </div>
    </div>
 </div>
        ...
        <label class="control-label">End Date<span class="required">*</span></label>
            <div class="controls">
                <asp:TextBox ID="TXT_END" runat="server" Placeholder="yyyy/MM/dd" CssClass="span12 m-wrap" autocomplete="off"/>
                    ...
                    <asp:RequiredFieldValidator Display="Dynamic" ErrorMessage="Fill End Date" ControlToValidate="TXT_END" runat="server"/>
            </div>
        </div>
    </div>
    <div class="span6" style="margin-bottom:-15px;">
