<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="DEVELOPMENT_LIST.aspx.cs" Inherits="DEVELOPMENT_LIST" Title="Development List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid" style="height: 120px;">
        ...
        <ul class="breadcrumb">
            ...
            <li>Development List</li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="DEVELOPMENT_CREATE.aspx" class="btn purple" style="text-align: right;">Create New Development</a>
                <asp:LinkButton class="btn red" Text="Delete Development" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton1" runat="server" />
            </div>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Development List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="DEV_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("DEV_ID")%>' onclick="SelectUnSelect(this)"
                                            id="chkSelect" />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Modify">
                                    <ItemTemplate>
                                        <a href='DEVELOPMENT_CREATE.aspx?id=<%#Eval("DEV_ID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetDevelopment" TypeName="BLLDEVELOPMENT"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_DEVELOPMENT_MASTER">
        <DeleteParameters>
            <asp:Parameter Name="DEV_ID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
...
function F()
{var res = confirm('Do You Want to Delete Development Detail?');
//alert(res);
if(res==false)
{return false;
}
