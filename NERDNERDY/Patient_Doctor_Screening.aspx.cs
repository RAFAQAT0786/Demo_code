            ...
            try
            {
                ...
                if (vATSession.UserType == "ADMIN")
                {
                    if (vID != null)
                    {
                        ...
                        Label1.Text = "NerdNerdy’s screening tool can screen all the Neurodevelopmental  disorders using one single set of questionnaire. It is designed for ages 2 to 16 years to screen children who may be at risk of having Neurodevelopmental  disorder." +
                        "<br><b> Directions -</b> It is recommended to watch the Training tutorial before you start answering the questions. The tutorial explains every question explicitly thus increases the accuracy of marking the correct responses." +
                        "<br>Please answer the given questions in ‘Yes’ and ‘No’, that best describes the child based on your observations. After all the questions are answered, click ‘Save’ button and you will get immediate result." +
                        "<br>The disorder with the highest scored percentage in results is the one that is most likely to be present.";

                        Label2.Text = "NerdNerdy’s screening scale is to be used for the reference purposes only. The results of the tests should be  clinically correlated by the medical/rehabilitation specialist. The screening tool should not be understood to constitute any type of diagnosis or healthcare recommendation for patients.";
                        ...
                        vHashtable07.Add("VD_ANMID", "1");
                        vHashtable07.Add("VD_AGRPID", AGRP_ID.Value);
                       
                        DataTable dt07 = DBManager.Get(vHashtable07, "GET_SCREEN_TEMPLATE_VIDEO_LINK");
                        DataRow vDR07 = RetDR(DBManager.Get(vHashtable07, "GET_SCREEN_TEMPLATE_VIDEO_LINK"));
                        if (vDR07 != null)
                        {
