<%@ Page Language="C#" MasterPageFile="~/Admin.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="Patient_Profile.aspx.cs" Inherits="Patient_Profile" Title="Patient Profile Information" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title"><span class="username">
            <asp:Label ID="PTP_TXT" runat="server" /></span> Profile Information</h3>
        <ul class="breadcrumb">
            ...
            <div class="span12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-reorder"></i>Patient Profile Information
                        </div>
                    </div>
                    <div class="portlet-body form">
                        ...
                        <div class="form-horizontal">
                            <div class="row-fluid">
                                <div class="span6" style="margin-bottom: -15px;">
                                    <div class="control-group">
                                        <label class="control-label">Patient Condition<span class="required">*</span></label>
                                        <div class="controls">
                                ...
                                <div class="span6" style="margin-bottom: -15px;">
                                    <div class="control-group">
                                        <label class="control-label">Condition Description<span class="required">*</span></label>
                                        <div class="controls">
                                            <asp:TextBox ID="PTP_COND_DESC" runat="server" CssClass="span12 m-wrap" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span6" style="margin-bottom: -15px;">
                                    <div class="control-group">
                                        <label class="control-label">Patient Relation<span class="required">*</span></label>
                                        <div class="controls">
                                            <asp:UpdatePanel ID="UpdatePanel4" UpdateMode="Conditional" runat="server">
                                                <ContentTemplate>
                                                    <asp:DropDownList ID="RELATION_DDL" runat="server" CssClass="span12 m-wrap">
                                                        <asp:ListItem Text="---Select Relation---"></asp:ListItem>
                                                        <asp:ListItem Text="GrandMother"></asp:ListItem>
                                                        <asp:ListItem Text="GrandFather"></asp:ListItem>
                                ...
                                <div class="span6" style="margin-bottom: -15px;">
                                    <div class="control-group">
                                        <label class="control-label">Relation Description<span class="required">*</span></label>
                                        <div class="controls">
                                            <asp:TextBox ID="PTP_REL_DESC" runat="server" CssClass="span12 m-wrap" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row-fluid">
                                <div class="span6" style="margin-bottom: -15px;">
                                    <div class="control-group">
                                        <label class="control-label">Patient Development<span class="required">*</span></label>
                                        <div class="controls">
                                            <asp:DropDownList ID="DEVCOND_ID" runat="server" CssClass="span12 m-wrap"></asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                                <div class="span6" style="margin-bottom: -15px;">
                                    <div class="control-group">
                                        <label class="control-label">Development Description<span class="required">*</span></label>
                                        <div class="controls">
                                            <asp:TextBox ID="PTP_DEV_DESC" runat="server" CssClass="span12 m-wrap" />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Patient Profile List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="PTF_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("PTF_ID")%>' onclick="SelectUnSelect(this)"
                                            id="chkSelect" />
                                    </ItemTemplate>
                                ...
                                <asp:BoundField DataField="PTF_RELATION" HeaderText="RELATION NAME" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:BoundField DataField="DEV_NAME" HeaderText="DEVELOPMENT NAME" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderStyle-CssClass="colhide" HeaderText="ID2" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="PTF_ID" Visible="false" runat="server" Text='<%#Eval("PTF_ID")%>'></asp:Label>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetParentProfileNEW" TypeName="BLLPROFILE"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_PT_PROFILE">
        <DeleteParameters>
            <asp:Parameter Name="PTF_ID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
