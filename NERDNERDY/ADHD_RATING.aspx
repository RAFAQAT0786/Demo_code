<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/DOCTOR.master" CodeFile="ADHD_RATING.aspx.cs" Inherits="ADHD_RATING" Title="ADHD Rating Detail" %>
    ...
    <script type="text/javascript" src="assets/plugins/bootstrap-wysihtml5/wysihtml5-0.3.0.js"></script> 
     <script type="text/javascript" src="assets/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.js"></script>
        ...
        <div class="row-fluid" style="height:120px;"> 
            <h3 class="page-title"><span class="username"><asp:Label ID="Label1" runat="server"/></span>Attention Defecit Hyperactive Disorder</h3>
                <ul class="breadcrumb" >
                    <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
                    <li><i class="icon-table"></i> <a href="Patient.aspx">Patient List</a> <i class="icon-angle-right"></i></li>
                    <li>Attention Defecit Hyperactive Disorder</li>
                </ul>
            </div>    
    <div class="row-fluid">
        <div class="span12">
            <h1 class="page-title-instruction"><b>Instructions & Directions</b></h1>
    ...
    <div class="span12">
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption"><i class="icon-table"></i>Attention Defecit Hyperactive Disorder</div>
                <div class="tools">
            ...
            <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" Width="100%" Height="100%"
                ...
                <Columns>
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:CheckBox runat="server" value='<%#Eval("ADHD_ID")%>' onclick="SelectUnSelect(this)" id="CheckBox2" />
                         </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="ID" HeaderStyle-Width="900px" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="ADHD_ID" runat="server" Text='<%#Eval("ADHD_ID")%>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Category" HeaderStyle-Width="900px">
                        <ItemTemplate>
                            <asp:Label ID="ADHD_NAME" runat="server" Text='<%#Eval("ADHD_NAME")%>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="left"/>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Traits" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="300px">
                        <ItemTemplate>
                            <asp:Label ID="ADHD_TRAIT" runat="server" Text='<%#Eval("ADHD_TRAIT")%>'></asp:Label>
                            <%--<asp:Label ID="ADHD_TRAIT" runat="server" Text='<%#Eval("ADHD_TRAIT")%>' Width="300px"></asp:Label>--%>
                        </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    </asp:TemplateField>
                 </Columns>
        ...
        <asp:GridView ID="GridView2" AutoGenerateColumns="false" runat="server" Width="100%" Height="100%"
                ...
                <Columns>
                    <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                        ...
                        <ItemTemplate>
                            <asp:CheckBox runat="server" id="chkSelect" AutoPostBack="True" Checked='<%# Eval("PTADHD_STATUS").ToString()=="1" ? true : false %>' Enabled='<%#(String.IsNullOrEmpty(Eval("PTADHD_STATUS").ToString()) ? false: true) %>' />
                            </ItemTemplate>
                        <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="ID" HeaderStyle-Width="900px" Visible="false">
                        <ItemTemplate>
                            <asp:Label ID="ADHD_ID" runat="server"></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="left"/>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="Category" HeaderStyle-Width="900px">
                        <ItemTemplate>
                            <asp:Label ID="PTADHD_ADHDID" runat="server" Text='<%#Eval("ADHD_NAME")%>'></asp:Label>
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="left"/>
                    </asp:TemplateField>
