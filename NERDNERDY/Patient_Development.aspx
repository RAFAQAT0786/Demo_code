<%@ Page Language="C#" MasterPageFile="~/Admin.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="Patient_Development.aspx.cs" Inherits="Patient_Development" Title="Patient Development Information" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="span12">
                ...
                <div class="portlet box green">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="icon-reorder"></i>Patient Development Information
                        </div>
                    </div>
                            ...
                            <div class="row-fluid">
                                <div class="span6" style="margin-bottom: -15px;">
                                    <div class="control-group">
                                        <label class="control-label">Development Condition<span class="required">*</span></label>
                                        <div class="controls">
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Patient Development Condition List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="PTDEV_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("PTDEV_ID")%>' onclick="SelectUnSelect(this)"
                                            id="chkSelect" />
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="colhide" HeaderText="ID2" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="PTDEV_ID" Visible="false" runat="server" Text='<%#Eval("PTDEV_ID")%>'></asp:Label>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetPatientDevelopmentGet" TypeName="BLLPATIENTDEVELOPMENT"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_PT_DEVELOPMENT">
        <DeleteParameters>
            <asp:Parameter Name="PTDEV_ID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
