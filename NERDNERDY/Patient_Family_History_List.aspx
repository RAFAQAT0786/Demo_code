<%@ Page Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Patient_Family_History_List.aspx.cs" Inherits="Patient_Family_History_List" Title="Patient List" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="row-fluid" style="height: 120px;">
        <h3 class="page-title">Patient Family Historty List</h3>
        <ul class="breadcrumb">
            <li><i class="icon-home"></i><a href="Admin_Welcome.aspx">Home</a> <i class="icon-angle-right"></i></li>
            <li><i class="icon-table"></i><a href="Patient.aspx">Patient List</a> <i class="icon-angle-right"></i></li>
            <li>Patient Family Historty List</li>
        </ul>
    </div>
    <div class="row-fluid" style="margin-bottom: 8px;">
        <div class="span12">
            <div class="portlet-body" style="text-align: right;">
                <a href="Patient_Family_History.aspx" class="btn purple" style="text-align: right;">Create New Patient Family Historty</a>
                <asp:LinkButton class="btn red" Text="Delete Patient Family Historty" OnClientClick="return F();" OnClick="btnDelete_Click" ID="LinkButton1" runat="server" />
            </div>
        </div>
    </div>
        ...
        <div class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-table"></i>Patient Family Historty List</div>
                    <div class="tools">
                ...
                <div class="portlet-body">
                    <div class="table table-striped table-bordered table-hover">
                        <asp:GridView Width="100%" DataSourceID="ObjectDataSource1"
                            DataKeyNames="PTFH_ID" AutoGenerateColumns="False" AllowPaging="True"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left">
                                    ...
                                    <ItemTemplate>
                                        <input type="checkbox" value='<%#Eval("PTFH_ID")%>' onclick="SelectUnSelect(this)"
                                            id="chkSelect" />
                                    </ItemTemplate>
                                ...
                                <asp:BoundField DataField="PTFH_RELATION" HeaderText="RELATION" HeaderStyle-HorizontalAlign="Left">
                                    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
                                </asp:BoundField>
                                <asp:TemplateField HeaderText="Modify">
                                    <ItemTemplate>
                                        <a href='Patient_Family_History.aspx?id=<%#Eval("PTFH_ID")%>' class="btn blue icn-only"><i class="icon-edit icon-white"></i></a>
                                    </ItemTemplate>
    ...
    <asp:ObjectDataSource
        OnDeleted="ObjectDatasource1_Deleted" SelectMethod="GetPatientFHis" TypeName="BLLAge"
        ID="ObjectDataSource1" runat="server" DeleteMethod="GET_PT_FAMILY_HIST">
        <DeleteParameters>
            <asp:Parameter Name="PTFH_ID" Type="String" />
        </DeleteParameters>
        <SelectParameters>
...
function F()
{var res = confirm('Do You Want to Delete Patient Family History Detail?');
//alert(res);
if(res==false)
{return false;
}
